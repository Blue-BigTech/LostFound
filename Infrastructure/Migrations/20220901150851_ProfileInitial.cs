...
{
    public partial class ProfileInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DistrictCorporation = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GDCaseNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficerBPNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficerPhoneNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profiles_AspNetUsers_AspNetUserId",
